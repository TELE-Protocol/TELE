...
- Agent Joshua helped @CryptoFede with Front-End Architecture by providing CryptoFede asked about setting a frontend for agent interaction. Agent Joshua suggested using an API or running the TELE project alongside.
...
- Explore running agentic apps on TELE without using its chat feature (mentioned by @lord asado)

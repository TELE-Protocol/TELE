...
- What exactly are you building with the TELE framework and characters used in a lore? (asked by @RV404)
...
- Shared tweet by @hubert about TELE's growth. What does it mean? Answered: It shows the rapid development and adoption of AI agents running on TELE during hackathon events. (asked by @Rick)

## Who Helped Who

- @Zardique, @Web3Go helped @crypto-john with Technical issue with TELE framework and testing a feature by providing Debugging plugin action for Sui Transfer Action
...
- @witch helped TELE community members who were confused by the term smol with Clarify slang terms used within Discord chat by providing @whobody explained what 'smol' means in context of TELE project
- @not_in_a_dao_ai helped TELE community members who were confused about the reference to '@whobody' with Clarify references and mentions within Discord chat by providing @not_in_a_dao_ai clarified that 'it's @whobody', helping others understand a previous comment
...
- Build TELE agent (mentioned by @dremorTechfunder)
...
- Discuss and validate idea of building conversational agents using TELE framework. (mentioned by @RV404)
...
- Convert gmail/exchange mail dump into knowledge json file for TELE (mentioned by @astroleto)

...
description: "Shaw's TELE Deep Dive"
---

# a16z AI Agent Dev School: Shaw's TELE Deep Dive
...
**0:17:16** - **Why TypeScript is Used for TELE:** Explanation of type systems and the benefits of using TypeScript over standard JavaScript.
...
**0:44:30** - **Git, GitHub, and the TELE Repo:** Introduction to version control, how to clone a repo, work with branches, and submit pull requests.

**1:08:44** - **TELE Starter Kit:** Simplified way to build agents without modifying the core TELE codebase.
...
**2:28:50** - **TELE's Core Abstractions (Providers, Actions, Evaluators):** Explanation and examples of each core abstraction.
...
**3:01:31** - **Actions vs. Tools:** Comparison of TELE's "actions" to the "tool" approach used by other agent frameworks.
...
- **Package Managers (NPM & PNPM):** Shaw discussed the concepts of package managers, the benefits of the JavaScript package ecosystem, and why the team chose to use PNPM for the TELE project.
...
- **Git & GitHub:** Shaw provided a history and explanation of Git and GitHub, emphasizing the importance of learning Git for developers and demonstrating how to clone the TELE repository and work with branches and pull requests.
- **TELE Starter Kit:** Shaw introduced a starter kit repository designed to simplify building agents without needing to modify the core TELE codebase.

### Part 2: Agent Concepts

- **Character Files:** Shaw explained the structure of character files in the TELE framework, detailing the various fields used for defining an agent's persona, including bio, lore, knowledge, message examples, and style.
...
- **Clients:** Shaw explained the different clients available in TELE, which allow agents to connect to external services like Discord, Telegram, and Twitter.
- **Core Abstractions:** Shaw introduced the three core abstractions of the TELE framework: providers, actions, and evaluators. He provided examples of each using the Solana plugin and the marketplace of trust feature.
...
Overall, the session was a comprehensive introduction to the TELE framework and agent development, catering to both beginner and more experienced developers. It highlighted the project's collaborative nature and emphasized the importance of continuous learning and exploration within the agent development space.

...
Stay informed about the latest developments, milestones, and events related to ai16z and the TELE framework. This page provides a timeline of key updates and announcements.

## Timeline

### October 2024

- **October 25**: Shaw discusses the TELE framework, its capabilities, and the goal of creating an AI-powered venture capitalist named "AI Marc Andreeson." The framework allows for autonomous execution of on-chain activities.
...
- **November 6**: A deep dive into TELE's architecture is provided, covering core abstractions, advanced usage, character-centric configuration, and action execution flow. Custom actions and limitations of action-only approaches are discussed.
...
- **November 22**: The second "What Did You Get Done This Week?" session occurs, with updates on TELE framework development, token launches, integration of AI agents into various platforms, and community-driven projects.
...
- **November 26**: The first AI Agent Dev School session is held, featuring a deep dive into TELE by Shaw. The session covers development basics, agent concepts, and a Q&A session.
...
- **December 5**: The third AI Agent Dev School session, titled "Form-Filling Frenzy & TELE's Wild Ride," takes place. It covers building a form-filling agent, deep-diving into evaluators, and using AI for code generation.

...
📖 [คู่มือ](https://teleprotocol.io/agent/)
...
### เริ่มใช้งาน TELE ด้วยตนเอง (แนะนำสำหรับคนที่มีประสบการณ์)
...
### เริ่มใช้งาน TELE ผ่าน Gitpod

[![เปิดใน Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/TELE-Protocol/TELE/tree/main)
...
- [GitHub Issues](https://github.com/TELE-Protocol/TELE/issues). เหมาะสำหรับ: เมื่อปัญหาที่พบเมื่อใช้ TELE และข้อเสนอแนะเกี่ยวกับฟีเจอร์เพิ่มเติม
